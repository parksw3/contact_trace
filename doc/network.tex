...
In the presence of heterogeneity, susceptibility will be lower in the neighborhood of infected individuals, resulting in shorter realized generation intervals.
...
Second, since the number of susceptibles decreases over the course of an epidemic, the forward generation-interval distribution for a given epidemic period is always shorter than the intrinsic distribution \citep{champredon2015intrinsic}.
