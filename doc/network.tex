...
\jd{I think there's room to be clearer here. All three depletion effects are similar. Should we call them all depletion?: egocentric, local, global?} In general, there are two factors that cause spatial reduction in the mean generation interval: local spatial effects (e.g., in a household or neighborhood) and (2) population-level effects; 
