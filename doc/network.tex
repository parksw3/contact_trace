...
Therefore, correcting for temporal variation, but not for spatial variation, in an observed generation-interval distribution provides a link between $r$ and $\RR$ which allows us to estimate the reproductive number $\RR$ that is consistent with the realized infection process.
