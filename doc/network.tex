...
represent time relative to/from infection. \jd{Is this just time since infection?}
...
\end{equation}
where $f(a)$ represents a probability density over a (possibly multi-dimensional) aspect space.
\new{Essentially, the population-level egocentric kernel accounts for the probability that a susceptible individual been infected by the focal individual.}
...
} \jd{We should disentangle under-reporting from g-i estimation.}
