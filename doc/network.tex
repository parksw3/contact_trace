...
However, directly measuring the reproductive number often requires detailed knowledge of the natural history of a disease 
\dc{and also knowing the transmission chains; but that means doing some sort of contact tracing...}
 and may not be feasible early in an epidemic \citep{dietz1993estimation}.
