...
Right-censoring effect and egocentric effect are well-understood and can be corrected for.
While local and global spatial effects are difficult to estimate, we can make qualitative predictions about their effects on the realized generation intervals and reproductive number. 
Both local and global effects reduce number of infections that occur and shorten generation intervals but the time scale on which they matter differ:
local spatial effect will be important early in an epidemic whereas the global effect will be small until after the exponential growth period has ended.
