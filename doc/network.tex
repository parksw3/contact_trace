...
\jd{Any objection to conceptualizing global as mean susceptible depletion? Then it's easy to measure. It's the non-egocentric non-global that's the problem.}
...
The individual-level method uses the poisson process to estimate a likelihood for the observations from each individual:
\begin{equation}
