...
Several studies have associated the backward generation-interval distribution with the observed generation-interval distribution, but the backward generation-interval distribution only consider infections that are single generation apart from a focal time point.
Instead, contact tracing can be performed over multiple generations, all the way back to the primary case.
