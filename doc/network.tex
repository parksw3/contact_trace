...
This model, also referred to as the renewal equation, represents wide range of epidemic models.
Finally, assuming exponentially growing incidence ($i(t) = i(0) \exp(r t)$), we obtain the Euler-Lotka equation, which provides a direct link between speed and strength of an epidemic.
 \citep{lotka1907relation}:
\begin{equation}
